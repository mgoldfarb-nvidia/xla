...
// Caches multicast memories across executable invocations. Symmetric windows
// are deliberately execution-scoped because their registrations refer to the
// current execution's backing buffers.
